package kz.almaty.boombrains.ui.sign_pages.login_pages;
...
import kz.almaty.boombrains.ui.sign_pages.change_user.ResetActivity;
import kz.almaty.boombrains.viewmodel.auth_view_models.login_view_model.LoginViewModel;
import kz.almaty.boombrains.viewmodel.auth_view_models.login_view_model.LoginView;
    ...
    public void goToMain(MainLoginModel model) {
        if (model != null) {
            if (model.getStatus().equals("accepted")) {
                ...
                SharedPrefManager.setUserId(this, model.getUid());
