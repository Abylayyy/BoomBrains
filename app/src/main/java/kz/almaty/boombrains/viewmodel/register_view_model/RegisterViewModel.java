...
public class RegisterViewModel extends ViewModel {
    ...
    public void getRegisterLiveData(String email, String password, String username, Context context, RegisterView view) {
        final MutableLiveData<MainLoginModel> data = new MutableLiveData<>();
        APIService service = RetrofitClass.getApiService();
        view.showProgressBar();
        service.registerUser("BoomBrains", email, password, username).enqueue(new Callback<MainLoginModel>() {
            @Override
